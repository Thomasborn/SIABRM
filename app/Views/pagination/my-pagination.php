<div class="pagination ml-auto">
    ...
    <li class="page-item next-page"><a href="#" class="page-link">Prev</a></li> -->
</div>
...
<!-- <script type="text/javascript">
    ...
    $(function() {
        var numberOfItems = $(".rowe-content .rowe").length;
        ...
        function showPage(whichPage) {
            ...
            $(".rowe-content .rowe").hide().slice((currentPage - 1) * limitPerPage, currentPage * limitPerPage).show();

            $(".rowe-content li").slice(1, -1).remove();
