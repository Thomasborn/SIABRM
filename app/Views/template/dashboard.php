            ...
            <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p id="bul" class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Pendapatan Bulan Ini</p>
                            <h5 id="pend" class="mb-2 font-bold dark:text-green"></h5>
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p id="pen" class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Total Penyewa Baru Bulan </p>
                            <h5 id="penyewa" class="mb-2 font-bold dark:text-white"></h5>
                            <p class="mb-0 dark:text-white dark:opacity-60">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p id="ser" class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">New Clients</p>
                            <h5 id="servis" class="mb-2 font-bold dark:text-white">+3,462</h5>
                            <!-- <p class="mb-0 dark:text-white dark:opacity-60">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p id="peng" class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Sales</p>
                            <h5 id="pengeluaran" class="mb-2 font-bold dark:text-white"></h5>
                            <!-- <p class="mb-0 dark:text-white dark:opacity-60">
        ...
        <div class="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
                ...
                <p class="mb-0 text-sm leading-normal dark:text-white dark:opacity-60">
                    ...
                    <span class="font-semibold">4% Meningkat</span> di 2022
                </p>
    ...
    <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
        <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
            ...
            <div slide class="absolute w-full h-full transition-all duration-500">
                <img class="object-cover h-full" src="https://cdn0-production-images-kly.akamaized.net/0iaM7CignAlnoZZPD8dq7TfH74Y=/0x47:882x544/1200x675/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/1499401/original/045062900_1486444805-Tugu_Yogyakarta.jpg" alt="carousel image" />
                ...
                <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                    ...
                    <p class="mb-0 dark:opacity-80 text-2">Thomas and Wahyu</p>
                    <h5 class="mb-1 text-white">PENAMBANG CORE</h5>
                </div>
            </div>
...
<div class="flex flex-wrap mt-6 -mx-3">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
            <div class="p-4 pb-0 mb-0 rounded-t-4">
                <div class="flex justify-between">
                    <h6 class="mb-1 dark:text-white">Transaksi Harian</h6>
                ...
                <h6 class=" dark:text-white">Top Penyewa : <h6 id="penyw"></h6>
                </h6>
    ...
    <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-7/12 lg:flex-none">
        <div class="flex justify-between"> -->
    <div class="w-full max-w-md px-3 lg:w-5/12 lg:flex-none">
        <!-- <div class="p-4 pb-0 mb-0 rounded-t-4"> -->
        <div class="relative flex flex-col min-w-0 break-words bg-white border-8 border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl dark:bg-gray-950 border-black-125 rounded-2xl bg-clip-border">
            <h6 class="mb-1  dark:text-white text-center">Motor Tersedia</h6>
        </div>
        <div slider class="relative w-full h-full overflow-hidden rounded-2xl">

            <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                <div slider class="absolute w-auto h-auto transition-all duration-500">
                    <!-- <img class="object-cover h-full myslide" id="mySlides" src="< ?= base_url('assets/img/1667374833_afe803a7c480ac6caa4f.png') ?>" alt="carousel image" /> -->
                    <img class="object-cover h-auto max-w-xs myslide" id="mySlides" src="https://ik.imagekit.io/zlt25mb52fx/ahmcdn/uploads/product/colors/electro-matte-blue-2-14072021-053448.png" alt="carousel image" />
                    <img class="object-cover h-full myslide" id="mySlides" src="https://ik.imagekit.io/zlt25mb52fx/ahmcdn/uploads/product/colors/street-black-3-14072021-054120.png" alt="carousel image" />
                    <img class="object-cover h-full myslide" id="mySlides" src="https://o.remove.bg/downloads/7c71b00f-7819-4d0b-93e2-c84f14dd067a/kelebihan-honda-beat-esp-dibanding-honda-beat-pendahulunya-removebg-preview.png" alt="carousel image" />
                    <img class="object-cover h-full myslide" id="mySlides" src="http://bmspeed7.com/wp-content/uploads/2018/02/All-New-Honda-BeAT-2018-Filipina-Red-Black-BMSPEED7.COM_.png" alt="carousel image" />
                    <!--             
             <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                <div class="inline-block w-8 h-8 mb-4 text-center text-black bg-white bg-center rounded-lg fill-current stroke-none">
                    <i class="top-0.75 text-xxs relative text-slate-700 ni ni-camera-compact"></i>
...
<script>
    ...
    function setLineChart(dataset, dataset1) {
    ...
    function setLineChartTotal(dataset, datasets) {
        var tanggal = [];
    ...
    function chartsewa() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(result.data1, function(i, val) {
                    dataset1[val.month - 1] = val.total
                });
                // document.getElementById("name").innerHTML = bulan;
                setLineChart(dataset, dataset1)
            }
        });
    }
    ...
    function pendapatan() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (dataset == null) {
                    document.getElementById("pend").innerHTML = "Rp " + 0;
                } else {
                    document.getElementById("pend").innerHTML = "Rp " + dataset;
                ...
                document.getElementById("bul").innerHTML = "Pendapatan Bulan " + toMonthName(bul);
            }
        });
    }
    ...
    function penyewa() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (dataset == null) {
                    document.getElementById("penyewa").innerHTML = 0 + " penyewa";
                } else {
                    document.getElementById("penyewa").innerHTML = +dataset + " penyewa";
                ...
                document.getElementById("pen").innerHTML = "Penyewa baru Bulan " + toMonthName(bul);
            }
        });
    }
    ...
    function servis() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (dataset == null) {
                    document.getElementById("servis").innerHTML = 0 + " servis";
                } else {
                    document.getElementById("servis").innerHTML = +dataset + " servis";
                ...
                document.getElementById("ser").innerHTML = "Servis baru Bulan " + toMonthName(bul);
            }
        });
    }

    function servisbayar() {
        var chartExist = Chart.getChart("chartsewa"); // <canvas> id
        if (chartExist != undefined)
            chartExist.destroy();
        var today = new Date();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (dataset == null) {
                    document.getElementById("pengeluaran").innerHTML = "Rp " + 0 + " ";
                } else {
                    document.getElementById("pengeluaran").innerHTML = "Rp " + dataset + " ";
                ...
                document.getElementById("peng").innerHTML = "Pengeluaran Bulan " + toMonthName(bul);
            }
        });
    }
    ...
    function charttotal() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(result.datas, function(i, val) {
                    datasets[val.day - 1] = val.total
                });
                $.each(result.data1, function(i, val) {
                    //     dataset  [val.month - 1 ] = val.total
                    ...
                    // setLineChart(dataset)
                    if (bul == null) {
                        document.getElementById("penyw").innerHTML = " ";
                    } else {
                        // document.getElementById("Jumlah_Sewa").innerHTML = "Rp " + dataset1 + " ";
                        document.getElementById("penyw").innerHTML = bul + " ";
                    }
                });
                // document.getElementById("name").innerHTML = bulan;
                setLineChartTotal(dataset, datasets)
            }
        });
    }
</script>
