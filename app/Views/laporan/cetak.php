...
<main>
                    ...
                    <br>
                        <h5>Total Pendapatan Transaksi : Rp. <?= number_format($total,2,'', '.')?></h3>
                            </div>
                        ...
                        <tbody>
                            ...
                            foreach ($result as $value) : ?>
                                <tr>
                                    ...
                                    <td class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        <p id="tanggal_mulai" class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-80"> <?= number_format( ($value['lama_sewa'] * $value['harga_sewa']), 2, '', '.') ?></p>
                                    </td>
                                    <td class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                    ...
                                    <td class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-80"> <?= number_format( ($value['lama_sewa'] * $value['harga_sewa'] + ($value['denda'])), 2, '', '.') ?></p>
                                    </td>
