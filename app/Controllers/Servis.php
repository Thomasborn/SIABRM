...
public function restore(){
    ...
    public function delete($id)
    {
        ...
        if($dataPengembalian==null){
            $dataPengembalian = $this->servisModel->getserv($id);
            // dd($dataPengembalian);
        }
        $this->servisModel->delete($id);
        $this->motorModel->save([
            'id_motor' =>  $dataPengembalian['id_motor'],
