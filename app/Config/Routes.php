...
$routes->post('/pendapatan', 'Home::showpendapatan');
$routes->post('/penyewabaru', 'Home::penyewa');
$routes->post('/servisbaru', 'Home::servis');
$routes->post('/pengeluaran', 'Home::servisbayar');
...
$routes->group('servis', function ($b) {
    ...
    $b->get('entry/(:num)', 'Servis::create/$1');
    $b->get('restore/', 'Servis::restore');
    ...
    $b->delete('delete/(:num)', 'Servis::delete/$1');
...
$routes->group('user', function ($u) {
    ...
    $u->get('register', 'User::regis');

    $u->get('edit/(:any)', 'User::edit/$1');

    $u->post('edit/(:num)', 'User::update/$1');
    // $u->post('entry/(:num)', 'User::update/$1');
...
$routes->group('pengembalian', function ($u) {
    ...
    $u->delete('delete/(:num)', 'Pengembalian::delete/$1');
